...
| 角色 | 胜利條件 | 成本結構 |
|------|---------|---------|
| 🏪 零售商 | 總成本最低・缺貨週數為零 | 持有 $1/箱/週・缺貨 $10/箱/週 |
| 📦 批發商 | 總成本最低・滿足率≥95% | 持有 $2/箱/週・缺貨 $7/箱/週 |
| 🚛 分銷商 | 總成本最低・訂單波動最小 | 持有 $2/箱/週・缺貨 $5/箱/週 |
| 🏭 製造商 | 總成本最低・生產量最穩定 | 持有 $3/箱/週・缺貨 $3/箱/週 |
...
demo/beer_game_demo.html           ← GitHub Pages 免費托管
（單一 HTML 檔案，含多人+單人模式）
```
...
打開 `demo/beer_game_demo.html` 於瀏覽器，將 `SERVER_URL` 改為 `http://localhost:8080`。
...
2. Source: `main` branch，Folder: `/demo`
3. 儲存，約 1 分鐘後生效
...
3. 部署完成，得到：`https://beer-game-xxxx.onrender.com`
...
- 各角色總成本、缺貨週數、訂單波動度排名
- 需求模式標籤（☀️ 夏季旺季型 / ❄️ 冬季旺季型 / ⚡ 雙重衝擊型 / 💥 突發衝擊型 / 🌪️ 三重衝擊型）
...
- **多人模式**：連線至 Render 後端，支援 1-4 人 + Bot 填補
- **單人模式**：完全離線，AI 自動扮演其他三個角色
